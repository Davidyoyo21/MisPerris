                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item active">
                            <img src="img/Apolo.jpg" alt="Apolo" width="460" height="345">
                            <div class="carousel-caption">
                                <h3>Apolo</h3>
                                <p>Su llegada no lo esperaba, pero todo fue para mejor, llevarlo de paseo con la familia es una grata experiencia.</p>
                            </div>
                        </div>

                        <div class="item">
                            <img src="img/Duque.jpg" alt="Duque" width="460" height="345">
                            <div class="carousel-caption">
                                <h3>Duque</h3>
                                <p>El es un gran compañero, le encanta viajar y conocer distintos lugares. Un gran soñador.</p>
                            </div>
                        </div>

                        <div class="item">
                            <img src="img/Tom.jpg" alt="Tom" width="460" height="345">
                            <div class="carousel-caption">
                                <h3>Tom</h3>
                                <p>Estamos felices de tener a Tom en casa. Es un super fiel compañero.</p>
                            </div>
                        </div>
...
<!--    <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.2/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body>    
    <div class="container">    
        <div class="row" style="text-align:center; border-bottom:1px dashed #ccc;  padding:0 0 20px 0; margin-bottom:0px;">
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
        ...
        <ul class="row">
            <li class="col-lg-4 col-md-2 col-sm-3 col-xs-4">
                <img class="img-responsive" src="img/Rescatados/Bigotes.jpg">
            </li>
            <li class="col-lg-4 col-md-2 col-sm-3 col-xs-4">
                <img class="img-responsive" src="img/Rescatados/Chocolate.jpg">
            </li>
            <li class="col-lg-4 col-md-2 col-sm-3 col-xs-4">
                <img class="img-responsive" src="img/Rescatados/Luna.jpg">
            </li>
            <li class="col-lg-4 col-md-2 col-sm-3 col-xs-4">
                <img class="img-responsive" src="img/Rescatados/Maya.jpg">
            </li>
            <li class="col-lg-4 col-md-2 col-sm-3 col-xs-4">
                <img class="img-responsive" src="img/Rescatados/Oso.jpg">
            </li>
            <li class="col-lg-4 col-md-2 col-sm-3 col-xs-4">
                <img class="img-responsive" src="img/Rescatados/Pexel.jpg">
            </li>
            <li class="col-lg-4 col-md-2 col-sm-3 col-xs-4">
                <img class="img-responsive" src="img/Rescatados/Wifi.jpg">
            </li>
          </ul>             
    </div> <!-- /container -->
  ...
  (function() {
    ...
    <footer>
        ...
        <i>Desarrollo Web y Mobile</i> 
         <center>2018 copyright &copy; asdas asdasdasasd </center>
         <br> 
    </footer>
</body>
</html>